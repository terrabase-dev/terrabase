...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/terrabase-dev/terrabase/gen/go/terrabase/organization/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OrganizationServiceName = "terrabase.organization.v1.OrganizationService"
)
...
const (
	...
	OrganizationServiceCreateOrganizationProcedure = "/terrabase.organization.v1.OrganizationService/CreateOrganization"
	// OrganizationServiceGetOrganizationProcedure is the fully-qualified name of the
	// OrganizationService's GetOrganization RPC.
	OrganizationServiceGetOrganizationProcedure = "/terrabase.organization.v1.OrganizationService/GetOrganization"
	...
	OrganizationServiceListOrganizationsProcedure = "/terrabase.organization.v1.OrganizationService/ListOrganizations"
	...
	OrganizationServiceUpdateOrganizationProcedure = "/terrabase.organization.v1.OrganizationService/UpdateOrganization"
	...
	OrganizationServiceDeleteOrganizationProcedure = "/terrabase.organization.v1.OrganizationService/DeleteOrganization"
)
...
// terrabase.organization.v1.OrganizationService service. By default, it uses the Connect protocol
...
func NewOrganizationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OrganizationServiceClient {
	...
	organizationServiceMethods := v1.File_terrabase_organization_v1_organization_proto.Services().ByName("OrganizationService").Methods()
...
// CreateOrganization calls terrabase.organization.v1.OrganizationService.CreateOrganization.
...
// GetOrganization calls terrabase.organization.v1.OrganizationService.GetOrganization.
...
// ListOrganizations calls terrabase.organization.v1.OrganizationService.ListOrganizations.
...
// UpdateOrganization calls terrabase.organization.v1.OrganizationService.UpdateOrganization.
...
// DeleteOrganization calls terrabase.organization.v1.OrganizationService.DeleteOrganization.
...
func NewOrganizationServiceHandler(svc OrganizationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/terrabase.organization.v1.OrganizationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOrganizationServiceHandler) CreateOrganization(context.Context, *connect.Request[v1.CreateOrganizationRequest]) (*connect.Response[v1.CreateOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.organization.v1.OrganizationService.CreateOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) GetOrganization(context.Context, *connect.Request[v1.GetOrganizationRequest]) (*connect.Response[v1.GetOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.organization.v1.OrganizationService.GetOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) ListOrganizations(context.Context, *connect.Request[v1.ListOrganizationsRequest]) (*connect.Response[v1.ListOrganizationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.organization.v1.OrganizationService.ListOrganizations is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) UpdateOrganization(context.Context, *connect.Request[v1.UpdateOrganizationRequest]) (*connect.Response[v1.UpdateOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.organization.v1.OrganizationService.UpdateOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) DeleteOrganization(context.Context, *connect.Request[v1.DeleteOrganizationRequest]) (*connect.Response[v1.DeleteOrganizationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.organization.v1.OrganizationService.DeleteOrganization is not implemented"))
}
