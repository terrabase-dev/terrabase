...
const (
	...
	UserServiceName = "terrabase.user.v1.UserService"
)
...
const (
	...
	UserServiceListUsersProcedure = "/terrabase.user.v1.UserService/ListUsers"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/terrabase.user.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/terrabase.user.v1.UserService/DeleteUser"
)
...
// NewUserServiceClient constructs a client for the terrabase.user.v1.UserService service. By
...
// ListUsers calls terrabase.user.v1.UserService.ListUsers.
...
// UpdateUser calls terrabase.user.v1.UserService.UpdateUser.
...
// DeleteUser calls terrabase.user.v1.UserService.DeleteUser.
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.user.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.user.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.user.v1.UserService.DeleteUser is not implemented"))
}
