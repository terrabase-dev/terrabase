...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/terrabase-dev/terrabase/gen/go/terrabase/application/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ApplicationServiceName = "terrabase.application.v1.ApplicationService"
)
...
const (
	...
	ApplicationServiceCreateApplicationProcedure = "/terrabase.application.v1.ApplicationService/CreateApplication"
	// ApplicationServiceGetApplicationProcedure is the fully-qualified name of the ApplicationService's
	// GetApplication RPC.
	ApplicationServiceGetApplicationProcedure = "/terrabase.application.v1.ApplicationService/GetApplication"
	// ApplicationServiceListApplicationsProcedure is the fully-qualified name of the
	// ApplicationService's ListApplications RPC.
	ApplicationServiceListApplicationsProcedure = "/terrabase.application.v1.ApplicationService/ListApplications"
	...
	ApplicationServiceUpdateApplicationProcedure = "/terrabase.application.v1.ApplicationService/UpdateApplication"
	...
	ApplicationServiceDeleteApplicationProcedure = "/terrabase.application.v1.ApplicationService/DeleteApplication"
	// ApplicationServiceGrantTeamAccessProcedure is the fully-qualified name of the
	// ApplicationService's GrantTeamAccess RPC.
	ApplicationServiceGrantTeamAccessProcedure = "/terrabase.application.v1.ApplicationService/GrantTeamAccess"
	// ApplicationServiceRevokeTeamAccessProcedure is the fully-qualified name of the
	// ApplicationService's RevokeTeamAccess RPC.
	ApplicationServiceRevokeTeamAccessProcedure = "/terrabase.application.v1.ApplicationService/RevokeTeamAccess"
)
...
// terrabase.application.v1.ApplicationService service. By default, it uses the Connect protocol
...
func NewApplicationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ApplicationServiceClient {
	...
	applicationServiceMethods := v1.File_terrabase_application_v1_application_proto.Services().ByName("ApplicationService").Methods()
...
// CreateApplication calls terrabase.application.v1.ApplicationService.CreateApplication.
...
// GetApplication calls terrabase.application.v1.ApplicationService.GetApplication.
...
// ListApplications calls terrabase.application.v1.ApplicationService.ListApplications.
...
// UpdateApplication calls terrabase.application.v1.ApplicationService.UpdateApplication.
...
// DeleteApplication calls terrabase.application.v1.ApplicationService.DeleteApplication.
...
// GrantTeamAccess calls terrabase.application.v1.ApplicationService.GrantTeamAccess.
...
// RevokeTeamAccess calls terrabase.application.v1.ApplicationService.RevokeTeamAccess.
...
func NewApplicationServiceHandler(svc ApplicationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/terrabase.application.v1.ApplicationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedApplicationServiceHandler) CreateApplication(context.Context, *connect.Request[v1.CreateApplicationRequest]) (*connect.Response[v1.CreateApplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.CreateApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) GetApplication(context.Context, *connect.Request[v1.GetApplicationRequest]) (*connect.Response[v1.GetApplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.GetApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) ListApplications(context.Context, *connect.Request[v1.ListApplicationsRequest]) (*connect.Response[v1.ListApplicationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.ListApplications is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) UpdateApplication(context.Context, *connect.Request[v1.UpdateApplicationRequest]) (*connect.Response[v1.UpdateApplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.UpdateApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) DeleteApplication(context.Context, *connect.Request[v1.DeleteApplicationRequest]) (*connect.Response[v1.DeleteApplicationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.DeleteApplication is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) GrantTeamAccess(context.Context, *connect.Request[v1.GrantTeamAccessRequest]) (*connect.Response[v1.GrantTeamAccessResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.GrantTeamAccess is not implemented"))
}
...
func (UnimplementedApplicationServiceHandler) RevokeTeamAccess(context.Context, *connect.Request[v1.RevokeTeamAccessRequest]) (*connect.Response[v1.RevokeTeamAccessResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.application.v1.ApplicationService.RevokeTeamAccess is not implemented"))
}
