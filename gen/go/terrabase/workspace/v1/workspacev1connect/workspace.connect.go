...
const (
	...
	WorkspaceServiceName = "terrabase.workspace.v1.WorkspaceService"
)
...
const (
	...
	// CreateWorkspace RPC.
	WorkspaceServiceCreateWorkspaceProcedure = "/terrabase.workspace.v1.WorkspaceService/CreateWorkspace"
	// WorkspaceServiceGetWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// GetWorkspace RPC.
	WorkspaceServiceGetWorkspaceProcedure = "/terrabase.workspace.v1.WorkspaceService/GetWorkspace"
	// WorkspaceServiceListWorkspacesProcedure is the fully-qualified name of the WorkspaceService's
	// ListWorkspaces RPC.
	WorkspaceServiceListWorkspacesProcedure = "/terrabase.workspace.v1.WorkspaceService/ListWorkspaces"
	// WorkspaceServiceUpdateWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// UpdateWorkspace RPC.
	WorkspaceServiceUpdateWorkspaceProcedure = "/terrabase.workspace.v1.WorkspaceService/UpdateWorkspace"
	// WorkspaceServiceDeleteWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// DeleteWorkspace RPC.
	WorkspaceServiceDeleteWorkspaceProcedure = "/terrabase.workspace.v1.WorkspaceService/DeleteWorkspace"
	// WorkspaceServiceGrantTeamAccessProcedure is the fully-qualified name of the WorkspaceService's
	// GrantTeamAccess RPC.
	WorkspaceServiceGrantTeamAccessProcedure = "/terrabase.workspace.v1.WorkspaceService/GrantTeamAccess"
	// WorkspaceServiceRevokeTeamAccessProcedure is the fully-qualified name of the WorkspaceService's
	// RevokeTeamAccess RPC.
	WorkspaceServiceRevokeTeamAccessProcedure = "/terrabase.workspace.v1.WorkspaceService/RevokeTeamAccess"
)
...
// NewWorkspaceServiceClient constructs a client for the terrabase.workspace.v1.WorkspaceService
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_terrabase_workspace_v1_workspace_proto.Services().ByName("WorkspaceService").Methods()
...
// CreateWorkspace calls terrabase.workspace.v1.WorkspaceService.CreateWorkspace.
...
// GetWorkspace calls terrabase.workspace.v1.WorkspaceService.GetWorkspace.
...
// ListWorkspaces calls terrabase.workspace.v1.WorkspaceService.ListWorkspaces.
...
// UpdateWorkspace calls terrabase.workspace.v1.WorkspaceService.UpdateWorkspace.
...
// DeleteWorkspace calls terrabase.workspace.v1.WorkspaceService.DeleteWorkspace.
...
// GrantTeamAccess calls terrabase.workspace.v1.WorkspaceService.GrantTeamAccess.
...
// RevokeTeamAccess calls terrabase.workspace.v1.WorkspaceService.RevokeTeamAccess.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/terrabase.workspace.v1.WorkspaceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspace(context.Context, *connect.Request[v1.CreateWorkspaceRequest]) (*connect.Response[v1.CreateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.CreateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspace(context.Context, *connect.Request[v1.GetWorkspaceRequest]) (*connect.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaces(context.Context, *connect.Request[v1.ListWorkspacesRequest]) (*connect.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateWorkspace(context.Context, *connect.Request[v1.UpdateWorkspaceRequest]) (*connect.Response[v1.UpdateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.UpdateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) DeleteWorkspace(context.Context, *connect.Request[v1.DeleteWorkspaceRequest]) (*connect.Response[v1.DeleteWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.DeleteWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GrantTeamAccess(context.Context, *connect.Request[v1.GrantTeamAccessRequest]) (*connect.Response[v1.GrantTeamAccessResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.GrantTeamAccess is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) RevokeTeamAccess(context.Context, *connect.Request[v1.RevokeTeamAccessRequest]) (*connect.Response[v1.RevokeTeamAccessResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.workspace.v1.WorkspaceService.RevokeTeamAccess is not implemented"))
}
