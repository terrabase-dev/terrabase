...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/terrabase-dev/terrabase/gen/go/terrabase/team/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TeamServiceName = "terrabase.team.v1.TeamService"
)
...
// NewTeamServiceClient constructs a client for the terrabase.team.v1.TeamService service. By
...
func NewTeamServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TeamServiceClient {
	...
	teamServiceMethods := v1.File_terrabase_team_v1_team_proto.Services().ByName("TeamService").Methods()
...
// CreateTeam calls terrabase.team.v1.TeamService.CreateTeam.
...
// GetTeam calls terrabase.team.v1.TeamService.GetTeam.
...
// ListTeams calls terrabase.team.v1.TeamService.ListTeams.
...
// UpdateTeam calls terrabase.team.v1.TeamService.UpdateTeam.
...
// DeleteTeam calls terrabase.team.v1.TeamService.DeleteTeam.
...
func NewTeamServiceHandler(svc TeamServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/terrabase.team.v1.TeamService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTeamServiceHandler) CreateTeam(context.Context, *connect.Request[v1.CreateTeamRequest]) (*connect.Response[v1.CreateTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.team.v1.TeamService.CreateTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) GetTeam(context.Context, *connect.Request[v1.GetTeamRequest]) (*connect.Response[v1.GetTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.team.v1.TeamService.GetTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) ListTeams(context.Context, *connect.Request[v1.ListTeamsRequest]) (*connect.Response[v1.ListTeamsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.team.v1.TeamService.ListTeams is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) UpdateTeam(context.Context, *connect.Request[v1.UpdateTeamRequest]) (*connect.Response[v1.UpdateTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.team.v1.TeamService.UpdateTeam is not implemented"))
}
...
func (UnimplementedTeamServiceHandler) DeleteTeam(context.Context, *connect.Request[v1.DeleteTeamRequest]) (*connect.Response[v1.DeleteTeamResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.team.v1.TeamService.DeleteTeam is not implemented"))
}
