...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/terrabase-dev/terrabase/gen/go/terrabase/environment/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EnvironmentServiceName = "terrabase.environment.v1.EnvironmentService"
)
...
const (
	...
	EnvironmentServiceCreateEnvironmentProcedure = "/terrabase.environment.v1.EnvironmentService/CreateEnvironment"
	// EnvironmentServiceGetEnvironmentProcedure is the fully-qualified name of the EnvironmentService's
	// GetEnvironment RPC.
	EnvironmentServiceGetEnvironmentProcedure = "/terrabase.environment.v1.EnvironmentService/GetEnvironment"
	// EnvironmentServiceListEnvironmentsProcedure is the fully-qualified name of the
	// EnvironmentService's ListEnvironments RPC.
	EnvironmentServiceListEnvironmentsProcedure = "/terrabase.environment.v1.EnvironmentService/ListEnvironments"
	...
	EnvironmentServiceUpdateEnvironmentProcedure = "/terrabase.environment.v1.EnvironmentService/UpdateEnvironment"
	...
	EnvironmentServiceDeleteEnvironmentProcedure = "/terrabase.environment.v1.EnvironmentService/DeleteEnvironment"
)
...
// terrabase.environment.v1.EnvironmentService service. By default, it uses the Connect protocol
...
func NewEnvironmentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EnvironmentServiceClient {
	...
	environmentServiceMethods := v1.File_terrabase_environment_v1_environment_proto.Services().ByName("EnvironmentService").Methods()
...
// CreateEnvironment calls terrabase.environment.v1.EnvironmentService.CreateEnvironment.
...
// GetEnvironment calls terrabase.environment.v1.EnvironmentService.GetEnvironment.
...
// ListEnvironments calls terrabase.environment.v1.EnvironmentService.ListEnvironments.
...
// UpdateEnvironment calls terrabase.environment.v1.EnvironmentService.UpdateEnvironment.
...
// DeleteEnvironment calls terrabase.environment.v1.EnvironmentService.DeleteEnvironment.
...
func NewEnvironmentServiceHandler(svc EnvironmentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/terrabase.environment.v1.EnvironmentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEnvironmentServiceHandler) CreateEnvironment(context.Context, *connect.Request[v1.CreateEnvironmentRequest]) (*connect.Response[v1.CreateEnvironmentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.environment.v1.EnvironmentService.CreateEnvironment is not implemented"))
}
...
func (UnimplementedEnvironmentServiceHandler) GetEnvironment(context.Context, *connect.Request[v1.GetEnvironmentRequest]) (*connect.Response[v1.GetEnvironmentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.environment.v1.EnvironmentService.GetEnvironment is not implemented"))
}
...
func (UnimplementedEnvironmentServiceHandler) ListEnvironments(context.Context, *connect.Request[v1.ListEnvironmentsRequest]) (*connect.Response[v1.ListEnvironmentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.environment.v1.EnvironmentService.ListEnvironments is not implemented"))
}
...
func (UnimplementedEnvironmentServiceHandler) UpdateEnvironment(context.Context, *connect.Request[v1.UpdateEnvironmentRequest]) (*connect.Response[v1.UpdateEnvironmentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.environment.v1.EnvironmentService.UpdateEnvironment is not implemented"))
}
...
func (UnimplementedEnvironmentServiceHandler) DeleteEnvironment(context.Context, *connect.Request[v1.DeleteEnvironmentRequest]) (*connect.Response[v1.DeleteEnvironmentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("terrabase.environment.v1.EnvironmentService.DeleteEnvironment is not implemented"))
}
